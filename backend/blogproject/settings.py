...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=30),  # disable if not needed
}
...
SECRET_KEY = 'django-insecure-#_h(o9j$o9dc!aqht0!ov3#*riysg0z57c$+usd5-%%4sdv_t3'
...
CORS_ALLOW_ALL_ORIGINS = True #allow from anywhere
